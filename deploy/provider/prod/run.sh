...
docker build -t 262870713489.dkr.ecr.cn-northwest-1.amazonaws.com.cn/pie-engine-application:piesat-school-rpc-1.0 .
docker push 262870713489.dkr.ecr.cn-northwest-1.amazonaws.com.cn/pie-engine-application:piesat-school-rpc-1.0
