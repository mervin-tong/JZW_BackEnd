...
sudo mv -f /apps/piesat-school/server/$tmpDir/piesat-school-rpc.jar /home/application/pie/piesat-school（pie+）/piesat-school-rpc/
sudo mv -f /apps/piesat-school/server/$tmpDir/piesat-school-rest.jar /home/application/pie/piesat-school（pie+）/piesat-school-rest/
...
cd /home/application/pie/piesat-school（pie+）/piesat-school-rpc/
sudo sh run.sh >/dev/null 2>&1 &

sleep 10

echo "start rest run.sh"

cd /home/application/pie/piesat-school（pie+）/piesat-school-rest/
sudo sh run.sh >/dev/null 2>&1 &
